...
Added highscore --
 NOTE: Chose for a minimalistic design with highscore only being a number, and no text saying 'highscore'

To add:
- nicer movement / input
- q does pausing, not quitting
...
class Screen:
    ...
    def show_screen(self, board, player, death_screen=False, start_screen=False):
        # renders the screen
