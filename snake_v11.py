...
class Board:
    ...
    def main(self):
        # display screen
        self.player.update(self.cols, self.rows)
        self.update_grid()
        self.screen.show_screen(self, score=self.player.score, start_screen=True)
        ...
        while True:
            ...
            self.update_grid()
            self.screen.show_screen(self, score=self.player.score)

            self.clock.tick(self.speed)

        # show death screen
        self.screen.show_screen(self, score=self.player.score, death_screen=True)
...
class Screen:
    ...
    def show_screen(self, board, score, death_screen=False, start_screen=False):
        # renders the screen
        ...
        # show score
        self.message(f"{score}", self.FONT2, self.WHITE, center=(self.block_size*1.5, self.block_size*1.5))
